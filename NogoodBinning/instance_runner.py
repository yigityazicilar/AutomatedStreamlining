...
def get_param_files(problem_directory: Path) -> List[Path]:
    ...
    param_dir = problem_directory / "params"
...
def generate_slurm_file(
    ...
    target_dir = results_dir / param_stem / str(seed)
    learnt_file = target_dir / f"{param_stem}.learnt"
    finds_file = target_dir / f"{param_stem}.finds"
    aux_file = target_dir / f"{param_stem}.aux"
    ...
    slurm_file = slurm_sh / f"{slurm_file_base}.sh"
    error_file = current_dir / slurm_stderr / f"{slurm_file_base}.error"
    out_file = current_dir / slurm_stdout / f"{slurm_file_base}.out"
